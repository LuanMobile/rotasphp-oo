...
class Pagination
{
    ...
    public function setItemsPerge(int $itemsPerPage)
    {
    ...
    public function links()
    {
        ...
        if($this->currentPage > 1)
        {
            ...
            $linkPage = http_build_query(array_merge($_GET, [$this->pageIdentifier => $previous])); // monsta uma query string
        ...
        if($this->currentPage < $this->totalPages)
        {
            ...
            $linkPage = http_build_query(array_merge($_GET, [$this->pageIdentifier => $next])); // monsta uma query string
