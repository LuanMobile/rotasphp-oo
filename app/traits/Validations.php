...
trait Validations
{
    public function unique($field, $param)
    {
        ...
        $model = new $param;
        $model->setFields('firstName, lastName, email');
    ...
    public function email($field)
    {
        ...
        {
            Flash::set($field, 'Esse campo deve ter um email válido');
            return null;
        }
    ...
    public function maxLen($field, $param)
    {
        ...
        {
            Flash::set($field, "O campo deve ter no máximo {$param} caracteres");
            return null;
        }
